...
description: "Learn how to build a conversational AI that queries your personal knowledge base using Nuxt, Nuxt Content, and the Anthropic SDK."
tags: ["nuxt", "ai", "typescript", "tutorial"]
draft: true
---
...
If you want to understand more about how Nuxt Content uses SQLite under the hood, check out [How SQLite Powers Nuxt Content](/blog/how-sqlite-powers-nuxt-content-deep-dive-beginners).
...
This creates an **agentic loop** - Claude keeps using tools until it has enough information to answer. For a deeper dive into how to build agentic systems, see [Building Your Own Coding Agent from Scratch](/blog/building-your-own-coding-agent-from-scratch).
...
We use embeddings - numerical representations of text meaning. Similar meanings produce similar vectors. For a more detailed explanation of how this works, see [Semantic Related Posts with Astro and Transformers.js](/blog/semantic-related-posts-astro-transformersjs).
...
To find similar notes, we compare vectors using cosine similarity. If you want to understand the math behind this, check out [Understanding Cosine Similarity for AI Applications](/blog/how-to-implement-a-cosine-similarity-function-in-typescript-for-vector-comparison).
...
-  - Deep dive into building agentic systems with tool loops
-  - Understanding Nuxt Content's SQLite architecture
-  - The math behind semantic similarity
